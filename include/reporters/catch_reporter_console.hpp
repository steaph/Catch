        ...
        std::pair<std::string, std::string> getMessage( AssertionResult const& _result ) {
            switch( _result.getResultType() ) {
                case ResultWas::ThrewException:
                    return std::make_pair( std::string("due to unexpected exception with message"), _result.getMessage() );
                case ResultWas::DidntThrowException:
                    return std::make_pair( std::string("because no exception was thrown where one was expected"), std::string("") );
                case ResultWas::Info:
                    return std::make_pair( std::string("with info"), _result.getMessage() );
                case ResultWas::Warning:
                    return std::make_pair( std::string("with warning"), _result.getMessage() );
                case ResultWas::ExplicitFailure:
                    return std::make_pair( std::string("explicitly with message"), _result.getMessage() );
                ...
                case ResultWas::Exception:
                    if( _result.hasMessage() )
                        return std::make_pair( std::string("with message"), _result.getMessage() );
                    else
